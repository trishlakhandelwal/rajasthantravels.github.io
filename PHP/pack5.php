...
<div class="frame">
	<h1>Jodhpur Udaipur Jodhpur Jaisalmer Bikaner Tour Package</h1>
<div class="container">
	<img class="slides" src="22.jpg" height="350px" width="100%">
</div><br><br>
<h2>Overview</h2>
<div class="main">
<b>Package Name:</b>Jodhpur Udaipur Jodhpur Jaisalmer Bikaner Tour Package<br><br>
<b>Duration:</b>7 Nights/8 Days<br><br>
<b>Price(per person on twin sharing):</b>Rs.23000/-<br><br>
<b>Rating:</b>4.0<br><br>
<h2>Itinerary Highlights</h2><br><br>
</div>
<div class="main2">
<br><b>Day 1:</b> Jaipur Pickup<br><br>
<b>Meals:</b> Dinner only<br><br>
Pickup from Jaipur Airport / Railway station and Proceed to Jaipur Jaipur Hotel after fresh up This morning%27s excursion takes you to Amber Fort. In the afternoon, explore Jaipur visiting Jantar Mantar, Continue past Moti Doongri Palace - a privately owned hilltop fort built like a Scottish castle - to Ram Niwas Gardens and architecturally impressive Albert Hall. City Palace, Jal Mahal & Hawa Mahal. Overnight stay in Hotel.
<br><br>
</div><br><br>

<div class="main2">
<br><b>Day 2:</b> Jaipur Full day sightseeing. <br><br>
<b>Meals:</b> Breakfast & Dinner<br><br>
After breakfast do full day sightseeing of Jaipur Local City Tomb of Salim Chisti, Panch Mahal and other Palaces. Proceed to Jaipur. Evening Check in hotel, rest of the day leisure. Overnight stay in Raghuraj Palace Jaipur.
<br><br>
</div><br><br>

<div class="main2">
<br><b>Day 3:</b> Jaipur to Udaipur(270 kms)<br><br>
<b>Meals:</b> Breakfast & Dinner<br><br>
...
<div class="main2">
<br><b>Day 4:</b> Udaipur Sightseeing<br><br>
<b>Meals:</b> Breakfast & Dinner<br><br>
...
<div class="main2">
<br><b>Day 5:</b> Udaipur to Jodhpur<br><br>
<b>Meals:</b> Breakfast & Dinner<br><br>
...
<div class="main2">
<br><b>Day 6:</b> Jodhpur to Jaisalmer<br><br>
<b>Meals:</b> Breakfast & Dinner<br><br>
...
<div class="main2">
<br><b>Day 7:</b> Jaisalmer to Bikaner with Sightseeing<br><br>
<b>Meals:</b> Breakfast only<br><br>
After breakfast move for local sight seen of jaisalmer, evening time go for Sand dunes, Take there Camel ride, and cultural program and back to the hotel, drive to Bikaner Tour, on arrival check in into hotel. Afternoon city tour covering Junagadh fort , Jain temples etc. Overnight at hotel.
<br><br>
</div><br><br>

<div class="main2">
<br><b>Day 8:</b> Bikaner to Jaipur Drop<br><br>
<b>Meals:</b> Breakfast only<br><br>
After Breakfast check out evening drop to derive and drop onwards destination airport/railway station. End of journey with Sweet Memories.
<br><br>
</div><br><br>
...
<div>
	<ul>
		<li>Deluxe Room Accomodations</li>
		<li>Pick and drop from Railway Station/Airport with driver Allowance & Fuel</li>
		<li>Toll Tax, State Permit tax & parking</li>
		<li>Transportation by Car</li>
		<li>All sightseeing by Transportation Car</li>
...
<div>
	<ul>
		...
		<li>Expenses of personal nature such as laundry,tips,telephone calls,etc</li>
		<li>5% GST Extra</li>
		<li>Driver Allowance</li>
		<li>Any adventure activity</li>
		<li>Any air/train/bus fare, Monument or Fort Entrance fee/Camera fees</li>
	</ul>
</div>

<h3>Transport Information</h3>
<div class="main4">
Car from Jodhpur to Jodhpur.<br><br>
</div>
...
<br>
Apart from above in some cases like Special Train Journeys, hotels or resorts bookings during the peak season (X-Mas, New Year), full payment is required to be sent in advance.<br><br>
</div>
...
In the event of cancellation of tour/travel services due to any avoidable/unavoidable reason/s, we must be notified of the same in writing. Cancellation charges will be effective from the date we receive advice in writing, and cancellation charges would be as follows: 
	...
	<b>Note</b>: Written cancellation will accept on all working days, except Sunday, Any cancellation sent on Sunday's will be considered on next working day (Monday).
For the X-mas and new year period from 20 Dec to 05 Jan the payment is non-refundable. In case you cancel the trip after commencement, the refund would be restricted to a limited amount only which too would depend on the amount that we would be able to recover from the hoteliers/ contractors we patronize. For unused hotel accommodation, chartered transportation & missed meals etc. we do not bear any responsibility to refund.<br><br>
</div>

<h3>Additional Information</h3>
<div class="main4">
For all the services contracted, certain advance payment should be made to hold the booking on the confirmed basis and the remaining amount should be paid definitely before the commencement of the services.<br>
Management holds the right to decide upon the amount to be paid as advance payment, based on the nature of the service & the time left for the commencement of the service.<br>
Apart from above in some cases like Special Train Journeys, hotels or resorts bookings during the peak season (X-Mas, New Year), full payment is required to be sent in advance.<br><br>
</div>
